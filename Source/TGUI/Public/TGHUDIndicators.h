...
public:
    ...
    void InitializeIndicators(UTGThermalComponent* ThermalComp, UTGChargeComponent* ChargeComp);
...
protected:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Appearance")
    FLinearColor ChargeColor = FLinearColor::Cyan;

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Appearance")
    FLinearColor DisruptionColor = FLinearColor::Magenta;
