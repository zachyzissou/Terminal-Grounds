...
public:
  ...
  void StartMatchTelemetry(const FString &MatchId, const FString &MapName,
  ...
  void SetPlayerHardwareInfo(const FString &GraphicsPreset, int32 Width,
                             int32 Height, bool bVSync);

  UFUNCTION(BlueprintCallable, Category = "Player")
  void SetInputMethod(const FString &InputMethod);

  UFUNCTION(BlueprintCallable, Category = "Player")
  void SetAccessibilitySettings(bool bColorblind, bool bMotionReduction,
                                float UIScale);
